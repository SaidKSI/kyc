...
const DOCS = [
  {
    name: "Moroccan CIN",
    detail: "Front + back · Arabic/Latin OCR · MRZ validation",
  },
  {
    name: "Passport (all)",
    detail: "TD1/TD2/TD3 · 7-checksum MRZ · 190+ countries",
  },
  { name: "Residence Permit", detail: "Carte de séjour · Front + back" },
  {
    name: "Driver's License",
    detail: "Permis de conduire · Categories extracted",
  },
];
    ...
    >
      ...
      <section className="max-w-6xl mx-auto px-5 pt-24 pb-20 text-center">
        ...
        <h1 className="text-4xl sm:text-6xl font-bold tracking-tight text-zinc-900 leading-tight mb-6 max-w-3xl mx-auto">
          ...
          <br className="hidden sm:block" /> that works in{" "}
          <span className="text-emerald-600">seconds</span>
        </h1>
        <p className="text-zinc-500 text-lg max-w-xl mx-auto mb-10 leading-relaxed">
          Self-hosted KYC for MENA fintechs and marketplaces. One API call —
          your users verify on mobile, you get a signed webhook with the
          decision and extracted data.
        </p>
      ...
      <section
        id="how-it-works"
        className="border-t border-zinc-100 py-24 bg-zinc-50"
      >
        <div className="max-w-6xl mx-auto px-5">
          <div className="text-center mb-14">
            ...
            <p className="text-zinc-500 text-sm max-w-md mx-auto">
              Integrate once. Your users verify from their phone — no SDK, no
              app install.
            </p>
          </div>
      ...
      <section id="features" className="border-t border-zinc-100 py-24">
        <div className="max-w-6xl mx-auto px-5">
          <div className="text-center mb-14">
            <h2 className="text-2xl sm:text-3xl font-bold text-zinc-900 mb-3">
              Full ML pipeline, out of the box
            </h2>
            <p className="text-zinc-500 text-sm max-w-md mx-auto">
              Every verification runs five checks in sequence — all async, all
              audited.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-14 items-center">
            <div>
              ...
              <p className="text-zinc-500 text-sm leading-relaxed mb-8">
                OCR fine-tuned on Arabic and French mixed-script documents. MRZ
                checksum validation for all passport formats. Template matching
                for known CIN layouts.
              </p>
      ...
      <section className="border-t border-zinc-100 py-24">
        <div className="max-w-2xl mx-auto px-5 text-center">
          ...
          <p className="text-zinc-500 text-sm mb-8">
            Run the dev tool, create a session, and test the full verification
            flow in under 5 minutes.
          </p>
          <Link
            href="/verify"
      ...
      <footer className="border-t border-zinc-100 py-8">
        <div className="max-w-6xl mx-auto px-5 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-zinc-400">
          ...
          <div className="flex items-center gap-6">
            <a href="/docs" className="hover:text-zinc-600 transition-colors">
              API Docs
            </a>
            <a href="/verify" className="hover:text-zinc-600 transition-colors">
              Dev Console
            </a>
          </div>
        </div>
